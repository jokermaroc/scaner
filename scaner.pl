#!usr/bin/perl
#      joker X >> assassins <<joker X
#     we are anonmous
#        /____/              assassins V 1.0::joker                     
# Coded by joker x [volcano team]
# telegram: @MR.jokermaroc
# assassins  v 1.0 [ Priv8 Tool ] 
...
##################################################################
# Coded by joker . Greetz : assassins :)
#                                  assassins We are anonymous    MR.joker x
###################################################################
...
use LWP::Simple; 
			print "\t-----------------------------\n";
			print "\t-- assassins  v 1.0\n";
			print "\t--    Coded By joker     \n";
			print "\t-- Greetz : volcano  \n";
			print "\t----------------------------\n\n";
